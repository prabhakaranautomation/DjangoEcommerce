...
class UserCards(models.Model):
    ...
    # Source mean device
    default_source_id = models.BooleanField(default=False)
    ...
    last4 = models.PositiveIntegerField(max_length=4, blank=True, null=True)
    funding = models.CharField(max_length=20,  blank=True, null=True)
    exp_month = models.PositiveIntegerField(max_length=2,  blank=True, null=True)
    exp_year = models.PositiveIntegerField(max_length=4,  blank=True, null=True)
...
class Order(models.Model):
    ...
    (failed checkout)
    3. Payment
    (preprocessing, preocessing, packaging, etc)
    4. being delivered
    5. Received
    6. Refunds
    '''
